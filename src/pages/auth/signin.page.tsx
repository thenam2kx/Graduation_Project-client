      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row shadow-2xl rounded-xl overflow-hidden bg-white">
          ...
          >
            ...
            <img className="w-full h-96 lg:h-screen object-cover" alt="Bộ sưu tập nước hoa" src="https://images.unsplash.com/photo-1590736704728-f4730bb30770?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8cGVyZnVtZXxlbnwwfHwwfHx8MA%3D%3D" />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            <motion.h1
              ...
              className="font-bold text-[#333333] text-2xl lg:text-3xl mb-6 lg:mb-8"
            >
              Đăng nhập
            </motion.h1>
            ...
            >
              ...
              <p className="mt-6 font-normal text-[#3c4242] text-sm lg:text-base">
                Chưa có tài khoản?{' '}
